...
# Edited by Jalyn Krause on 30 July 2019 - PRESENT
...
# We also need an estimate of the unobscured intensity, I0, to derive the transmission. Tr(lambda) = I(lambda)/I0(lambda)
